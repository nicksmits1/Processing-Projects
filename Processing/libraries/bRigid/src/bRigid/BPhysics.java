 ...
 * http://www.bulletphysics.com/ </p> bRigid written by Daniel Koehler - 2013
 * www.lab-eds.org - for feedback please contact me at: daniel@lab-eds.org
 */
public class BPhysics {
	...
	public ArrayList<BInterface> joints;
	/**
	 * jBullet world node
	 */
	...
	public BPhysics() {
		...
		GImpactCollisionAlgorithm.registerAlgorithm((CollisionDispatcher) this.world.getDispatcher());
		stepSimulation = 1;
	}
	...
	public void addJoint(BInterface constraint) {
		world.addConstraint((TypedConstraint) constraint, true);
		if (this.joints == null)
			this.joints = new ArrayList<BInterface>();
	...
	public int getStepSimulation() {
		return stepSimulation;
	}

	public void setStepSimulation(int stepSimulation) {
	...
	public void saveOBJ(String path) {
		...
		obj.beginSave(path);
		int counter = 0;
		for (BObject o : this.rigidBodies) {
			o.saveAsOBJ(obj, Integer.toString(counter));
			counter++;
		}
		obj.endSave();
	}
