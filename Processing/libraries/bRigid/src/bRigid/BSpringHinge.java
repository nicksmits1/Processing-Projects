 ...
 */
public class BSpringHinge extends HingeConstraint {

	
	public BSpringHinge(BObject a, BObject b, Vector3f pivotInA, Vector3f pivotInB, Vector3f axisInA, Vector3f axisInB) {
		super(a.rigidBody, b.rigidBody, pivotInA, pivotInB, axisInA, axisInB);
	}
	
	public BSpringHinge(BObject a, BObject b, Transform rbAFrame, Transform rbBFrame) {
