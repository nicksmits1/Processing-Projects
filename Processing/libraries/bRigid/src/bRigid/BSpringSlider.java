 ...
 */
public class BSpringSlider extends SliderConstraint {
	
	public BSpringSlider(BObject a, BObject b, Transform rbAFrame, Transform rbBFrame, boolean useLinearReferenceFrameA) {
