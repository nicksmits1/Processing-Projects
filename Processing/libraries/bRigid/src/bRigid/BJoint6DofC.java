 ...
 */
public class BJoint6DofC extends Generic6DofConstraint implements BInterface{
	
	//BObject a,b;
	
	public BJoint6DofC(BObject a, BObject b, Transform frameInA, Transform frameInB) {
		super(a.rigidBody, b.rigidBody, frameInA, frameInB, false);
	}
	
	public BJoint6DofC(BObject a, BPlane b, Transform frameInA, Transform frameInB) {
		super(a.rigidBody, b.rigidBody, frameInA, frameInB, false);
	}
