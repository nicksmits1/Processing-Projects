...
/**
 * ConvexHull as rigidBody, List of vertices, PShapes or .obj files as input and
 * calculates its convexHull for collisionDetection
 */
public class BConvexHull extends BObject implements BInterface {
	...
	private void importObj(PApplet p, String fileName) {
		PShape tempShape = p5.loadShape(fileName);
		tempShape.scale(1, -1, 1);
		translateMesh(tempShape);
	}
